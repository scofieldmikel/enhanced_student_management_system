            ...
            <div class="w-full sm:w-1/2 mr-2 mb-6">
                ...
                @foreach ($student->class->subjects as $subject)
                    <div class="flex items-center justify-between border border-gray-200 -mb-px">
                        ...
                        <div class="w-1/5 text-right text-gray-600 py-2 px-4 font-medium">
                            {{ optional($subject->student_grade->where('student_id', $student->id)->first())->grade ?? 'N/A' }}
                        </div>
                        <div class="w-1/5 text-right text-gray-600 py-2 px-4 font-medium">
                            {{ optional($subject->student_grade->where('student_id', $student->id)->first())->score ?? 'N/A' }}
                        </div>
